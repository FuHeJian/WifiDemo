...
public class RxTimer {
    ...
    public void interval(final long milliSeconds, final RxTimerAction rxAction) {
        Observable.interval(milliSeconds, TimeUnit.MILLISECONDS)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<Long>() {
                    @Override
                    ...
                    public void onNext(@NonNull Long number) {
                        if (rxAction != null) {
                            rxAction.action(number, RxTimer.this == null ? new RxTimer() : RxTimer.this);
                        }
                    }
    ...
    public interface RxTimerAction {
         ...
         * @param number
         */
        void action(long number, RxTimer rxTimer);
    }
}
