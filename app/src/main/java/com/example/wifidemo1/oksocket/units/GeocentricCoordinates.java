...
/**
 * This class corresponds to an object's location in Euclidean space  when it is projected onto a unit sphere (with the Earth at the  center).
 *
 * @author Brent Bryan
 */
...
//        float raRadians = Math.abs(ra * Geometry.DEGREES_TO_RADIANS);
//        float decRadians = Math.abs(dec * Geometry.DEGREES_TO_RADIANS);
