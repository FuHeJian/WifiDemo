...
import static com.example.wifidemo1.oksocket.server.action.IAction.Server.ACTION_CLIENT_CONNECTED;
import static com.example.wifidemo1.oksocket.server.action.IAction.Server.ACTION_CLIENT_DISCONNECTED;
import static com.example.wifidemo1.oksocket.server.action.IAction.Server.ACTION_SERVER_ALLREADY_SHUTDOWN;
import static com.example.wifidemo1.oksocket.server.action.IAction.Server.ACTION_SERVER_LISTENING;
import static com.example.wifidemo1.oksocket.server.action.IAction.Server.ACTION_SERVER_WILL_BE_SHUTDOWN;
