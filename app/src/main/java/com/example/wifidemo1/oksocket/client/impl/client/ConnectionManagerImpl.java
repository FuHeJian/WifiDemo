...
import com.example.wifidemo1.oksocket.client.impl.client.action.ActionHandler;
import com.example.wifidemo1.oksocket.client.impl.client.iothreads.IOThreadManager;
import com.example.wifidemo1.oksocket.client.impl.exceptions.ManuallyDisconnectException;
import com.example.wifidemo1.oksocket.client.impl.exceptions.UnConnectException;
...
import com.example.wifidemo1.oksocket.client.sdk.client.OkSocketSSLConfig;
import com.example.wifidemo1.oksocket.client.sdk.client.action.IAction;
...
import com.example.wifidemo1.oksocket.common.interfaces.default_protocol.DefaultX509ProtocolTrustManager;
    ...
    private class ConnectionThread extends Thread {
        ...
        public void run() {
            try {
                ...
                mSocket.connect(new InetSocketAddress(mRemoteConnectionInfo.getIp(), mRemoteConnectionInfo.getPort()), mOptions.getConnectTimeoutSecond() * 900);
